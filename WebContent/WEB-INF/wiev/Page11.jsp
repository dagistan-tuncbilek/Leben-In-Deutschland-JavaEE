...
<section>
	...
	<nav class="navbar-expand-sm" aria-label="fragen300">
		...
		<ul class="pagination justify-content-center">
			...
			<li class="page-item"><a class="page-link" href="PageServlet10"
			...
			<li class="page-item"><a class="page-link" href="PageServlet6">6 </a></li>
			...
			<li class="page-item"><a class="page-link" href="PageServlet12">Next</a></li>
